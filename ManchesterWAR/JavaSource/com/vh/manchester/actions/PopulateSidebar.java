/**
 * @file PopulateSidebar
 * @author peter.szocs
 * @version 1.0
 * 
 * Prepopulate vars for sidebar.jsp.
 */
 ...
 * @author		peter.szocs
 */
public class PopulateSidebar extends BaseAction {
	
	private static Logger log = Logger.getLogger(PopulateSidebar.class);	
