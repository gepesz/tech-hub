...
//	website : www.pengz.com
	...
	var imgDir = CONTEXT_PREFIX + "js/popcalendar/"; // directory for images ... e.g. var imgDir="/CONTEXT-PATH/popcalendar/"
    ...
    */
	...
	function init()	{
		if (!ns4)
		{
			...
			addHoliday(6,12,0,  "Santa Clause");
			addHoliday(25,12,0, "Christmas Day");
			addHoliday(1,1,0,   "New Year's Day");
			addHoliday(15,3,0,  "1848 Revolution");
